...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 22, 2021 at 06:07 PM
...
(8, 'Mahateer', 'UMT', 'mahateer@umt.edu.pk', '345678908765', 167, 'UMT Johar Town Lahore', 'Lahore', 'Punjab', '54570', 'Mahateer', 'SM Technology', '03448773013', 167, 'Room No.62 , UMT Boys Hostel', 'Lahore', 'Punjab', '54570', 'Mahateer', 'SM Technology', '03448773013', 167, 'Room No.62 , UMT Boys Hostel', 'Lahore', 'Punjab', '54570', '827ccb0eea8a706c4c34a16891f84e7b', '219cf3a15a6950f753299bfb16332fd7', '2021-01-19 06:44:15', '1611067455', 1),
(9, 'Ahmir', 'UMT', 'ahmir@umt.edu.pk', '03448773013', 167, 'Room No.62 , UMT Boys Hostel', 'Lahore', 'Punjab', '54570', 'Ahmir', 'UMT', '03448773013', 167, 'Room No.62 , UMT Boys Hostel', 'Lahore', 'Punjab', '54570', 'Ahmir', 'UMT', '03448773013', 167, 'Room No.62 , UMT Boys Hostel', 'Lahore', 'Punjab', '54570', '827ccb0eea8a706c4c34a16891f84e7b', '78110b2a5ff9f51ce3fddc641c867c40', '2021-01-19 07:38:29', '1611070709', 1),
(10, 'Sheikh Abdul Rehman', 'UMT', 'abdi@umt.edu.pk', '03448773013', 167, 'Room No.62 , UMT Boys Hostel', 'Lahore', 'Punjab', '54570', 'Sheikh Abdul Rehman', 'UMT', '03448773013', 167, 'Room No.62 , UMT Boys Hostel', 'Lahore', 'Punjab', '54570', 'Sheikh Abdul Rehman', 'UMT', '03448773013', 167, 'Room No.62 , UMT Boys Hostel', 'Lahore', 'Punjab', '54570', '827ccb0eea8a706c4c34a16891f84e7b', '6e67e6be39837bb1806271d121686230', '2021-01-19 07:39:25', '1611070765', 1),
(11, 'Minam Ullah Asif', 'UMT', 'minam@umt.edu.pk', '03448773013', 167, 'Room No.62 , UMT Boys Hostel', 'Lahore', 'Punjab', '54570', 'Minam Ullah Asif', 'UMT', '03448773013', 167, 'Room No.62 , UMT Boys Hostel', 'Lahore', 'Punjab', '54570', 'Minam Ullah Asif', 'UMT', '03448773013', 167, 'Room No.62 , UMT Boys Hostel', 'Lahore', 'Punjab', '54570', '827ccb0eea8a706c4c34a16891f84e7b', '554a293854bc08fcaf7aa871bedfa969', '2021-01-19 07:41:33', '1611070893', 1);
...
(52, 77, 'Laptop Backpack', '', 'Black', '1', '100', '1611068016'),
(53, 81, 'Black Wool Beanie & Bobble Hat For Unisex', '', 'Black', '1', '1', '1611068016'),
(54, 80, 'Jeans for Women - Denim', 'Free Size', 'Blue', '1', '249', '1611070280');
...
(48, 8, 'Mahateer', 'mahateer@gmail.com', '2021-01-19 18:53:36', '', 111, '', '', '', '', '', 'PayPal', 'Completed', 'Completed', '1611068016'),
(49, 8, 'Mahateer', 'mahateer@gmail.com', '2021-01-19 19:31:20', '', 259, '', '', '', '', '$249.99 Received from Bank of America USSID 78786789009988 ', 'Bank Deposit', 'Completed', 'Completed', '1611070280');
...
(77, 'Laptop Backpack', '', '100', 9, 'product-featured-77.jpg', '<div><font color=\"#0a0a0a\" face=\"opensans, Helvetica Neue, Helvetica, Helvetica, Arial, sans-serif\">Distinct design and pockets galore The striking, modern look of the Skedaddle Laptop Backpack exudes confidence with multi-functional pockets and protects your laptop.<br></font></div>', 'Baggallini Skedaddle Laptop Backpack specifically for women.', '<table>\r\n<tbody><tr>\r\n<td>Brand: </td>\r\n<td>Baggallini</td>\r\n</tr>\r\n<tr>\r\n<td>Features: </td>\r\n<td>Pockets: 3 interior slip, 3 interior zip, 4 exterior</td>\r\n</tr>\r\n<tr>\r\n<td>Target Group: </td>\r\n<td>Women</td>\r\n</tr>\r\n<tr>\r\n<td>Country of Origin: </td>\r\n<td>U.S.A</td>\r\n</tr>\r\n</tbody></table>', 'This product is directly shipped from U.S.A. and it includes import duty in the price.', '<p>Standard Return Policy</p>', 5, 1, 1, 60),
...
CREATE TABLE `tbl_settings` (
  `id` int(11) NOT NULL,
  `logo` varchar(114) NOT NULL,
  `favicon` varchar(114) NOT NULL,
  `footer_about` text NOT NULL,
  `footer_copyright` text NOT NULL,
  `contact_address` text NOT NULL,
  `contact_email` varchar(114) NOT NULL,
  `contact_phone` varchar(114) NOT NULL,
  `contact_fax` varchar(114) NOT NULL,
  `contact_map_iframe` text NOT NULL,
  `receive_email` varchar(114) NOT NULL,
  `receive_email_subject` varchar(114) NOT NULL,
  ...
  `banner_login` varchar(114) NOT NULL,
  `banner_registration` varchar(114) NOT NULL,
  `banner_forget_password` varchar(114) NOT NULL,
  `banner_reset_password` varchar(114) NOT NULL,
  `banner_search` varchar(114) NOT NULL,
  `banner_cart` varchar(114) NOT NULL,
  `banner_checkout` varchar(114) NOT NULL,
  `banner_product_category` varchar(114) NOT NULL,
  `banner_blog` varchar(114) NOT NULL,
  `cta_title` varchar(114) NOT NULL,
  `cta_content` text NOT NULL,
  `cta_read_more_text` varchar(114) NOT NULL,
  `cta_read_more_url` varchar(114) NOT NULL,
  `cta_photo` varchar(114) NOT NULL,
  `featured_product_title` varchar(114) NOT NULL,
  `featured_product_subtitle` varchar(114) NOT NULL,
  `latest_product_title` varchar(114) NOT NULL,
  `latest_product_subtitle` varchar(114) NOT NULL,
  `popular_product_title` varchar(114) NOT NULL,
  `popular_product_subtitle` varchar(114) NOT NULL,
  `testimonial_title` varchar(114) NOT NULL,
  `testimonial_subtitle` varchar(114) NOT NULL,
  `testimonial_photo` varchar(114) NOT NULL,
  `blog_title` varchar(114) NOT NULL,
  `blog_subtitle` varchar(114) NOT NULL,
  `newsletter_text` text NOT NULL,
  `paypal_email` varchar(114) NOT NULL,
  `stripe_public_key` varchar(114) NOT NULL,
  `stripe_secret_key` varchar(114) NOT NULL,
...
(12, 'group', 'group@umt.edu.pk', '', '81dc9bdb52d04dc20036dbd8313ed055', 'user-13.jpg', 'Super Admin', 'Active');
